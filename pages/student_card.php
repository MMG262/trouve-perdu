...
if (isset($_POST['soumissionOrdinateur'])) {
    ...
    if (!post_fields_filled(['prénom', 'nom', 'date_de_naissance', 'numéro_unique', 'université', 'lieu'])) {
    ...
    nom, date_de_naissance, numéro_unique, université, lieu) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)');
    $req->execute(array(
        $_SESSION['id_user'],
        $_SESSION['objet'],
        $_SESSION['état'],
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <h1 class="text mb-0">Carte étudiant</h1>
      <div class="container">
        <div class="row px-3">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <div class="inputContainer">
                                <div class="input">
                                    ...
                                    <input type="text" placeholder="Entrez la nationalité" name="université" required>
                                </div>
                            </div>
                        </div>
                        </div>
