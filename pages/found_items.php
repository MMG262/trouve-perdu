    ...
    <nav class="navbar navbar-expand-lg navbar-light ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ">
              ...
              <li class="nav-item ">
                <div class="nav-item1">
                <a class="nav-link active" aria-current="page" href="found_items.php"><span>Objets Trouvés</span></a>
      ...
      <div class="container">
        <div class="row choixContainer">
            <?php
              // Afficher la table objet dont l'état_objet = trouver et l'ordonner par ordre décroissant selon le id_objet
              $donnees = $bdd->query('SELECT * FROM objet WHERE état_objet="Trouver" ORDER BY id_objet DESC ');
            ...
            ?>
              <div class="col-md-4 choix">
                ...
                <div>
                  ...
                  ?>
                      <p>Etat : <span class="badge-success"><?php echo htmlspecialchars($reponse['état_objet']); ?></span></p>
